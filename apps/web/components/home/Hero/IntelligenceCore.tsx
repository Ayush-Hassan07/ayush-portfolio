...
export default function IntelligenceCore() {
  ...
  function activateWithDelay(
    ...
    /*
      A clicked/pinned node owns the active
      state until it is toggled off.
    */
    if (pinned) {
      return;
    }
  ...
  function scheduleDeactivate() {
    ...
    /*
      The small delay creates a safe bridge
      between the node and its information
      panel.
